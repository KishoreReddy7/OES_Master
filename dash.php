...
<!--add quiz start-->
<?php
    if(@$_GET['csubmit']=='csubmit'){
        $cname = @$_GET['course'];
        $cid=uniqid();
        $result = mysqli_query($con,"INSERT into courses values('$cid','$cname') ") or die('Error');
    }
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="total" name="total" placeholder="Enter total number of questions" class="form-control input-md" type="number" pattern="[1-9]{1}[0-9]*" min="1" required="">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label" for="cate"></label>
  <div class="col-md-12">
    <select id="cate" name="cate" class="form-control input-md" >
...
</div>can\'t Find The course ?? -> 
<a href="#" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><b>Add New Course</b></a>
<!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label" for="tag"></label>
  <div class="col-md-12">
  <input id="tag" name="tag" placeholder="Enter #tag ( Without Hash ) which is used for searching" class="form-control input-md" type="text" required="">
  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      <div class="modal-header">
        ...
        <h4 class="modal-title title1"><span style="color:orange">Add Course</span></h4>
      </div>
      <div class="modal-body">
        <form class="form-horizontal" action="dash.php" type="POST">
<fieldset>


<!-- Text input-->
<div class="form-group">
  <label class="col-md-3 control-label" for="course"></label>  
  <div class="col-md-6">
  <input id="course" name="course" placeholder="Enter The Course Name" class="form-control input-md" type="text" required="">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="csubmit" value="csubmit" class="btn btn-primary">Submit</button>
		</fieldset>
</form>
</div>
</div>
...
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Question Details</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6"><form class="form-horizontal title1" name="form" action="update.php?q=addqns&n='.@$_GET['n'].'&eid='.@$_GET['eid'].'&cid='.@$_GET['cid'].'&ch=4 "  method="POST">
<fieldset>
';
